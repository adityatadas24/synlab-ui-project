    ...
    <div className=" mt-24 mb-20">
      <div className=" bg-[#fafafa] p-8 ">
        <div className="container mx-auto mt-8 mb-8">
          <div className="flex justify-between items-center ">
            <div>
              <h1 className="text-5xl text-[#9f6cb9] mb-3 bg-gradient-to-r from-violet-400 via-indigo-700 to-indigo-800 inline-block text-transparent bg-clip-text">The OG Creators</h1>
      ...
      <div className=" bg-[#f7efec] p-8">
        <div className="container mx-auto mt-6 mb-6">
          <div className="flex justify-between items-center ">
            <h1 className="text-5xl font-semibold text-[#9f5208] mb-3">
              Categories
            </h1>
          ...
          <div className="flex flex-row flex-wrap items-center mt-5 gap-4">
            <div className="h-max  md:w-1/3 lg:w-[19%]">
