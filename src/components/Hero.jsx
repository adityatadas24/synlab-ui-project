...
const Hero = () => {
  return (
    <div className="container mx-auto mt-36 mb-20 flex items-center w-full gap-10 flex-col md:flex-row">
      <div className="bg-[#fafafa] rounded-3xl p-8 w-5/6 h-max">
        <h1 className="text-2xl mb-5">👋</h1>
        <h1 className="text-5xl text-[#9f6cb9] mb-5 bg-gradient-to-r from-violet-400 via-indigo-700 to-indigo-800 inline-block text-transparent bg-clip-text">
          Simplifying Influencer Marketing For You!
        </h1>
        <p className=" text-xl mb-6 w-3/4">
          Explore creators across youtube, instagram & Facebook to curate unique
          content for your brand
        </p>
        <div className="flex flex-wrap items-center gap-4">
          <div className="h-8 text-lg md:h-44">
