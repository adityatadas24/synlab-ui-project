    ...
    <div className=" p-8 ">
      <div className="container mx-auto mb-8">
        <div className="flex justify-between items-center ">
          <div>
            <h1 className="text-5xl text-[#9f6cb9] mb-3 bg-gradient-to-r from-violet-400 via-indigo-700 to-indigo-800 inline-block text-transparent bg-clip-text">{title}</h1>
        ...
        <div className="flex flex-row flex-wrap gap-10">
          <div className="h-max  md:w-1/3 lg:w-[23%] bg-white p-4 shadow-lg rounded-xl">
            ...
            <div className="flex justify-between items-center pt-2 pb-3">
              ...
              <div>
                <h2 className="text-2xl font-semibold pl-3">2.6M</h2>
          ...
          <div className="h-max  md:w-1/3 lg:w-[23%] bg-white p-4 shadow-md rounded-xl">
            ...
            <div className="flex justify-between items-center pt-2 pb-3">
              ...
              <div>
                <h2 className="text-2xl font-semibold pl-3">1.6M</h2>
                <p className="text-[#797979]">Followers</p>
              </div>
            </div>
            <hr className="text-[#797979]" />
          ...
          <div className="h-max  md:w-1/3 lg:w-[23%] bg-white p-4 shadow-md rounded-xl">
            ...
            <div className="flex justify-between items-center pt-2 pb-3">
              ...
              <div>
                <h2 className="text-2xl font-semibold pl-3">1.8M</h2>
                <p className="text-[#797979]">Followers</p>
              </div>
            </div>
            <hr className="text-[#797979]" />
