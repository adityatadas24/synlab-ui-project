    ...
    <div className=" bg-[#fafafa] p-10 ">
      <div className="container mx-auto mt-8 mb-8 flex justify-between items-center flex-col w-11/12">
        <div className="flex justify-between items-center w-full">
          <div>
            <h1 className="text-3xl text-[#9f6cb9] mb-3 bg-gradient-to-r from-violet-400 via-indigo-700 to-indigo-800 inline-block text-transparent bg-clip-text max-md:text-2xl">On The Rise</h1>
